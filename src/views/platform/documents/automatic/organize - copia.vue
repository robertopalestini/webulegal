...
<template>
        ...
        <div class="container-fluid">
            ...
            <form class="row" @submit.prevent="save()">
               <div class="col-md-2" style="height:calc(100vh - 70px);overflow:hidden;overflow-y:auto;padding:0;"> 
                ...
                <div class="col-md-10 text-center" style="padding:20px;border:1px solid #F3F3F3;background:rgb(255,255,255,0.1);height:calc(100vh - 70px);overflow:hidden;overflow-y:auto;">
    ...
    <a href="@" @click.prevent="$router.go(-1)" > <img src="@/assets/flecha-izquierda.svg" style="height:20px;width:20px;" /> </a>
                    ...
                    <div class="col-md-5"  >
                        ...
                        <div class="col-md-12" >
                             <h4 style="font-weight:bold;text-align:left;font-size:17px">Clasifica el documento dentro de la categoria que corresponda.</h4>
                         </div>
...
<ul style="padding: 0px;list-style: none;width: 100%;display: flex;justify-content: flex-start;align-items: center;flex-direction: column;align-content: flex-start;margin-top:30px">
...
<NewFolderModal />
                     ...
                     <div class="col-md-7 " style="position:relative;z-index:1000"> 
                           ...
                           <div style="position:sticky;top:0;z-index:1000">
                            ...
                            <ul style="padding:0;list-style: none;border-top-left-radius: 10px;border-top-right-radius: 10px;display: flex;flex-wrap: wrap;flex-direction: row;margin-top:15px;margin-bottom:15px" >
                                <li style="padding: 5px;background:#ECECEC;border-radius:30px;font-size:12px;font-weight:600;margin-right:10px;padding-left:8px;padding-right:8px;margin-bottom:5px;"  v-for="(tag,index) in tagSelected"> {{tag.data.title}} <a href="#" @click="removeTag(index)">
                                    <img src="@/assets/cerrar-simbolo-de-boton-circular.png"  style="max-width:15px;max-height:15px;" /></a>
                                </li> 
                            </ul>


                             <div class="col-12" style="padding-top:0px;">
                                <h4 style="font-weight:bold;text-align:left;font-size:17px">Asignale al documento como minimo tres etiquetas</h4>
                                <input type="text" class="form-control input-search-dashboard" placeholder="Escribe para agregar una etiqueta"   @keyup="searchTags" v-model="searchInputTags.target" />
                            ...
                            <div class="col-12" style="border-radius:8px;margin-top:10px;max-height:400px;overflow:hidden;overflow-y:auto;padding:0;" v-if="searchInputTags.target" >
                             <ul style="width:100%;padding:0;margin:0;list-style:none;">
                 
                             <li style="padding:15px;width:100%;text-align:left;background:#f6f5f5;border-bottom:1px solid #e6e6e6;font-size:12px;color:black;font-weight:500;"  v-for="(searchTag, index)   in tags" >
                              {{searchTag.data.title}}  <a href="#" style="font-size:13px;font-weight:600;" @click.prevent="selectTag(index)"><img src="@/assets/boton-agregar.png" style="width:20px;height:20px;" /> </a> 
                             </li>  
                             </ul>
                            </div>
                            ...
                            <div class="col-12" style="padding-top:50px;">
                                <h4 style="font-weight:bold;text-align:left;font-size:17px">Escribe un titulo para tu documento</h4>
                                <input type="text" class="form-control input-search-dashboard" placeholder="Escribir titulo"  v-model="data.title" required="true" />
                            </div>


                            <div class="col-12" style="padding-top:50px;">
                                <h4 style="font-weight:bold;text-align:left;font-size:17px">Escribe una descripcion para tu documento</h4>
                                <input type="text" class="form-control input-search-dashboard" placeholder="Escribir descripcion"  v-model="data.description" />
                            </div>


                            <div class="col-12 text-center"  style="padding-top:50px;">
                              <button type="submit" class="btn btn-primary" style="width:120px;position:relative"  v-if="!loadingSave"> Crear</button>

                              <button type="submit" class="btn btn-primary" style="width:120px;position:relative" disabled="true" v-if="loadingSave"> 
