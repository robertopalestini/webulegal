...
<NewFolderModal />
                     ...
                     <div class="col-md-7 " style="position:relative;padding-top:0;"> 
                           ...
                           <div style="position:sticky;top:0;padding-top:0;">
                              ...
                              <ul style="padding:0;list-style: none;border-top-left-radius: 10px;border-top-right-radius: 10px;display: flex;flex-wrap: wrap;flex-direction: row;margin-top:0;margin-bottom:15px" >
                            ...
                            <div class="col-12" style="padding-top:50px;">
                                ...
                                <input type="text" class="form-control input-search-dashboard" placeholder="Escribir titulo"  v-model="data.title" required="true" maxlength="100" />
                            </div>


                            <div class="col-12" style="padding-top:50px;">
                                <h4 style="font-weight:bold;text-align:left;font-size:17px">Escribe una descripcion para tu documento</h4>
                                <input type="text" class="form-control input-search-dashboard" placeholder="Escribir descripcion"  v-model="data.description" required="true"  maxlength="350" />
                            </div>
