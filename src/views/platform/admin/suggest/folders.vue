<template>
   ...
   <div class="col-md-12" style="margin-bottom:30px">
                             <h4 style="font-weight:bold;text-align:left;font-size:17px">Solicitudes de carpetas</h4>
             </div>
 ...
 <div class="col-md-12 text-left" style="padding:15px;font-size:12px;margin-bottom:15px;border:1px solid #E7E7E7" v-for="item in data"  v-if="data.length > 0">
                 ...
                 <p><b>Tipo de documento</b> : <span v-if="item.data.type == 'writing'">Escrito</span> <span v-if="item.data.type == 'document'">Documento</span></p> 
               </div>
...
export default {
  data() {
    return {
      ...
      endpoint: window.ENDPOINT + '/requests/get/all/folder',
      inputCreate:null,
      tags:[],
      history:[],
      searchTarget:null,
