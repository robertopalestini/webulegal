...
export default {
    data() {
        return {
            ...
            endpointGetAll: window.ENDPOINT + '/folders/v2/default/documents',

            endpointSave: window.ENDPOINT + '/folders/v2/default/documents/save/root',
  ...
  // this.saveFolders();
      ...
      openModalEdit(folder,index)  {
        ...
        saveEditFolder() {
            ...
            fetch(window.ENDPOINT + '/folders/v2/default/documents/edit', requestOptions).then(response => response.json()).then((data) => {
        ...
        saveRootFolder() {
            ...
            fetch(window.ENDPOINT + '/folders/v2/default/documents/save/root', requestOptions).then(response => response.json()).then((data) => {
        ...
        saveChildFolder() {
            ...
            fetch(window.ENDPOINT + '/folders/v2/default/documents/save/child', requestOptions).then(response => response.json()).then((data) => {
        ...
        saveDeleteFolder(id) {
            ...
            fetch(window.ENDPOINT + '/folders/v2/default/documents/delete', requestOptions).then(response => response.json()).then((data) => {
                this.$Progress.finish();
            })
        },
