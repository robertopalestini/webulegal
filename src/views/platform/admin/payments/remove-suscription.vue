...
<template>
           ...
           <div class="row justify-content-center">
             ...
             <div class="col-md-12">
               <div class="col-md-12" style="margin-bottom:30px">
                   <h4 style="font-weight:bold;text-align:left;font-size:17px">Bajas de suscripcion</h4> 
               </div>
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Id de suscripcion</th>
    </tr>
  </thead>
  <tbody>
    ...
    data() {
      return {
        ...
        form : {
           ...
           endpoint: window.ENDPOINT + '/admin/payments/suscriptions/remove',
