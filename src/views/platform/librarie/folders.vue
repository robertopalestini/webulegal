        ...
        <div class="modal-body">
          <div class="container-fluid">
            <div class="col-12" v-if="document" style="padding: 10px">
              ...
              <ckeditor id="editor" :editor="editorCK" @ready="onReadyCK" v-model="document.data.content"
                v-html="document.data.content" style="
                  height: calc(80vh);
  ...
  methods: {
    ...
    selectTag(index) {
      if (this.tagSelected.length < 5) {
        ...
        for (t in this.tagsSelected) {
          if (this.tagsSelected[t].id == this.tagSelected.id) {
        ...
        if (!encontrado) {
          ...
          this.$toast.show("Ya seleccionaste esta etiqueta", {
