								...
								<div class="tab-pane fade" :class="{ 'active show': isActive('folders') }" id="folders">
									...
									<div class="col-12" style="padding-top:10px;padding-bottom:0">
										...
										<ul style="padding:0;margin:0;width:100%;list-style:none" v-if="items.length > 0">
											<li style="padding:0;margin:0;width:100%;list-style:none" v-for="item in filteredResources"
									...
									<div class="col-12" style="padding-top:10px;padding-bottom:10px">
										...
										<a href="#" style="font-size:13pX;font-weight:600;" @click.prevent="openCreateFolderRootModal()">
											<img src="@/assets/admin-add.png" style="width:20px;" /> Nueva carpeta
											raiz</a>

										<hr />


										<a href="#" style="font-size:13pX;font-weight:600;" @click.prevent="loadAllDocuments()"> Todos los
											documentos</a>
										...
										<span style="font-size:12px;font-weight:500;" v-if="treeDisplayData.length == 0">No
											se encontraron carpetas.</span>
                 ...
                 <a href="#" style="font-size:13px;">Nueva carpeta</a>
									...
									<div class="col-12" style="padding-top: 10px; padding-bottom: 10px">
										...
										<div class="col-12 text-left" style="padding: 0" v-if="tagsSelectedTags.length > 0">
											...
											<ul
												...
												<li
													...
													<a href="#"
														style="font-size: 12px; padding-top: 5px; padding-bottom: 5px; background: rgb(206, 206, 206); border-radius: 30px; display: flex; place-content: flex-start; align-items: center; flex-direction: row; font-weight: 600; padding-left: 10px; padding-right: 10px">
														{{ tagSelectedTags.title }}
														<a href="#" style="margin-left: 10px"
															@click="removeFilterTags(index, tagSelectedTags.title)">
										...
										<ul style="padding: 0; margin: 0; width: 100%; list-style: none" v-if="itemsTags.length > 0">
											<li
												style="padding: 0; margin: 0; width: 100%; list-style: none; line-height: 15px; margin-bottom: 15px"
												v-for="item in filteredResourcesTags" :key="index"
												@click.prevent="getDocumentsByTag(item._id, item.data.title)">
												<a href="#" style="color: black; font-weight: 600; font-size: 12px">
													{{ item.data.title }}
												</a>
											</li>
										</ul>
						...
						<div class="col-md-6 scroll-size-medium"
										...
										<component v-if="document.data.complete == 1">
											<div class="dropdown" style="margin:5px;display:inline">
												...
												<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
													<a class="dropdown-item" href="#" @click.prevent="exportWord()">Documento
														Word</a>
													<a class="dropdown-item" href="#" @click.prevent="exportPDF()">Documento
														PDF</a>
												</div>
											</div>
										</component>
							...
							<ckeditor id="editor" :editor="editorCK" @ready="onReadyCK" v-model="contentDocument"
								v-html="contentDocument" style="
  ...
  yes it was my bad passing the string-->
				...
				<div class="modal-body">
					<div class="container-fluid">
						<div class="col-12" v-if="document" style="padding:10px">
							...
							<ckeditor id="editor" :editor="editorCK" v-model="document.data.content" style="
                                height: calc(80vh); 
	...
	<div style="
		...
		<div style="
			...
			<button type="button" class="close" data-dismiss="modal" aria-label="Close" @click="popshared = false"><span
	...
	methods: {
		...
		saveShare(value, activeDocumentId) {
			...
			if (value == 1) {
				...
				this.$router.push({ name: 'document-organize', params: { id: activeDocumentId } })
