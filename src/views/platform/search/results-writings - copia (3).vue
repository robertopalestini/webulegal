...
<navBar /> 
    ...
    <a href="@" @click.prevent="$router.go(-1)" > <img src="@/assets/flecha-izquierda.svg" style="height:15px;width:15px;" /> </a>
                                    ...
                                    <div class="col-md-9" style="padding:0;margin-bottom:15px">
                                        ...
                                        <input type="text" class="form-control type-input-4" v-model="searchInput.target" />
                                    ...
                                    <div class="col-md-12" style="padding: 15px;background: rgb(243 243 243);padding-top: 3px;padding-bottom: 3px;font-size: 13px;font-weight: 600;color: #505050;margin-bottom: 15px;margin-top: 15px;text-transform: uppercase;">
                                        Carpetas
                                    </div>
                                    <div class="col-md-12">
...
">
                                ...
                                <div class="col-md-9 scroll-size-medium" style="height:calc(100vh - 70px);overflow:hidden;overflow-y:auto;padding-top:15px">
                                  <div class="row" style="border:1px solid #d0cece;border-radius:8px;width:100%;">
                                     <div class="col-md-12" style="
                                     padding: 15px;background: rgb(251 251 251);padding-top: 3px;padding-bottom: 3px;font-size: 13px;font-weight: 600;color: #505050;margin-bottom: 15px; text-transform: uppercase;border-top-left-radius: 8px;border-top-right-radius: 8px;">Resultados de busqueda</div>
 ...
 pathMoveSelectedRemove(index,nodeid) {
   ...
   getResults() { 
      ...
      const requestOptions = {
         ...
         fetch( window.ENDPOINT + '/comunity/search/complete/writings', requestOptions).then(response => response.json()).then((data) => { 
          if(data.length == 0) {
