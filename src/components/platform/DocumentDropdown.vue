...
const emit = defineEmits(['goEditPrivate', 'openModalMoveDocument', 'openModalAddTags', 'saveShare', 'deleteDocument', 'openCompartirPrivada'])
  ...
  <div v-if="document.data.complete == 0">
    <div class="dropdown" style="margin: 5px; display: inline">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        ...
        <a class="dropdown-item" href="#" @click="saveShare()">
