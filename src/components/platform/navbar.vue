      ...
      <div class="row">
        <div class="col-md-2 text-center">
          <a
            ...
            href="/"
            ><img
              src="@/assets/Logocompleto.svg"
              class="img-fluid"
              style="max-width: 140px; margin-top: 25px"
          /></a>
        </div>
        <div
        ...
        >
          ...
          >
            ...
            <li style="padding: 0; display: flex">
              <RouterLink
                to="/platform/dejanos-tu-opinion"
                style="padding-left: 20px; padding-right: 20px; font-size: 15px"
              >
          ...
          <transition name="slide">
            ...
            >
              ...
              <div
                ...
                "
              >
                <RouterLink to="/change/points" style="font-size: 12px"
                  >Canjear</RouterLink
                >
              </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      ...
      >
        ...
        >
          ...
          <h1
            class="text-center"
            style="font-size: 60px; font-weight: 600; margin-top: 50px"
          >
            ${{ amount }}
          </h1>
          ...
          <a
            :href="link"
            class="btn btn-primary"
            style="width: 200px; position: relative; z-index: 1000"
            >Suscribirme</a
          >
        </div>
